namespace P05.DragonArmy
{
    ...
    class Program
    {
        public static void Main()
        {
            ...
            Dictionary<string, Dictionary<string, double[]>> dragonStatistic = new Dictionary<string, Dictionary<string, double[]>>();
            ...
            for (int i = 0; i < numberOfDragons; i++)
            {
                ...
                if (dragonDamage == "null") dragonDamage = "45.00";
                string dragonHealth = tokens[3];
                if (dragonHealth == "null") dragonHealth = "250.00";
                string dragonArmor = tokens[4];
                if (dragonArmor == "null") dragonArmor = "10.00";
                ...
                {
                    dragonStatistic[dragonType].Add(dragonName, new double[] { double.Parse(dragonDamage), double.Parse(dragonHealth), double.Parse(dragonArmor) });
                }
                else
                {
                    dragonStatistic[dragonType][dragonName] = new double[] { double.Parse(dragonDamage), double.Parse(dragonHealth), double.Parse(dragonArmor) };
                }
            }
